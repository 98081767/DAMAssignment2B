...
set.seed(42) #for runif

#r_unif - is a random number between 0 and 1 and getting values less than 0.8
...
#Notice that it differs with different seeds but not at the top. Split different a lower levels.
